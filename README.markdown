...
+ [Chicago Boss](http://chicagoboss.org/) uses gen_smtp for its mail API.
...
You may wish to configure DKIM signing [RFC6376](https://tools.ietf.org/html/rfc6376) of outgoing emails
